...
interface Props {
  loadItems: (authToken: AuthToken, userAlias: string, pageSize: number, lastItem: User | null) => Promise<[User[], boolean]>;
...
const UserItemScroller = (props: Props) => {
  ...
  const loadMoreItems = async () => {
    try {
      const [newItems, hasMore] = await props.loadItems(authToken!, displayedUser!.alias, PAGE_SIZE, lastItem);
